...
export function PublicationDetailModal({ publication, isOpen, onClose }: PublicationDetailModalProps) {
      ...
      <div className="relative z-10 mx-4 max-h-[90vh] w-full max-w-3xl overflow-hidden rounded-lg bg-card shadow-2xl">
        ...
        <div className="max-h-[90vh] overflow-y-auto">
          ...
          <div className="relative h-48 sm:h-64">
            <Image src={publication.image || "/placeholder.svg"} alt={publication.title} fill className="object-cover" />
  ...
  <div className="flex items-center gap-3">
    ...
    {publication.githubUrl && (
      <a
        ...
        className="inline-flex h-9 w-9 items-center justify-center rounded-full bg-background/80 text-foreground transition-colors hover:bg-cyan-500 hover:text-black"
      >
  ...
  <p className="mt-1 text-xl text-muted-foreground">{publication.subtitle}</p>
</div>
          </div>
          ...
          <div className="p-6 space-y-6">
            ...
            <div>
              ...
              <div className="flex flex-wrap gap-2">
                {publication.techStack.map((tech) => (
                  <span
                    key={tech}
